...
class Picupload extends Element {
    ...
    public $templates = array(
        ...
        'restrictions_block' => 'aef/fe/picupload/restrictions.tpl',
        'restrictions_row' => 'aef/fe/picupload/restrictions_row.tpl',
    ...
    function parseRestrictionsBlock(){
        ...
        if($this->restrictions !== false){
            //if(is_int($this->rstr_items['maxWidth'])) $rsts[] = \Lang::get('fe picupload restrictions maxWidth', array('maxWidth' => $this->rstr_items['maxWidth']));
            //if(is_int($this->rstr_items['maxHeight']))   $rsts[] = \Lang::get('fe picupload restrictions maxHeight', array('maxHeight' => $this->rstr_items['maxHeight']));
