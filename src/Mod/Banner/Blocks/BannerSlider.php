<?php
namespace Verba\Mod\Banner\Blocks;

use Verba\QueryMaker;

class BannerSlider extends \Verba\Block\Html
{
    ...
    public function build()
    {
        ...
        while($item = $sqlr->fetchRow()){
            ...
            if(!empty($item['picture'])){
                $imgCfg = $mImage->getImageConfig($_banner->p('picture_config') ?? $item['_picture_config']);
